<div class="grid_12 breadcrumbs"><p>
		<a href="<?php echo  base_url();?>theatre_view#<?php echo $theatre['theatre_id'];?>">&lt;&lt; &nbsp;back to list</a>
	</p>
</div>
<!-- Featured theatres -->
<div class="grid_12 featuredarea">   
	...
	<div class="grid_3 alpha sidebar">
		<div class="entryDetails">
			...
			<h4><a href="<?php echo  base_url();?>theatre_view/entry_visitor_info/<?php echo $curr_theatre_ref;?>">Visitor information</a></h4>
                        	<ul>
								<li>Overview</li>
			...
			<h4 class="active"><a href="<?php echo  base_url();?>theatre_view/entry_scholarly_details/<?php echo $curr_theatre_ref;?>">Scholarly details</a></h4>
                        	<ul>
...
<div class="grid_9 basics alpha omega">
    ...
    <div class="grid_9 alpha omega">
        <h3>Alternative names ("aliases")</h3>
        <div class="grid_4 alpha">
            <h4>Alternative names for this theatre</h4>
            <?php foreach($t_aliases as $theatre_alias):?>
            <div class="grid_3 prefix_1 alpha"><em>
                - <?php echo $theatre_alias['theatre_alias'];?></em>
            </div>
            <?php endforeach;?>
        </div>
        <div class="grid_5 omega">
            ...
            <div class="grid_4 prefix_1 omega"><em>
                - <?php echo $city_alias['city_alias'];?></em>
            </div>
            <?php endforeach;?>
        </div>
    </div>
    ...
    <div class="grid_9 basics alpha omega">
        ...
        <div id="noStyle">
            <?php echo $theatre['general_history'];?>
        </div>
        <h3><a name="arch_history">Architectural History</a></h3>
        <h4>Previous Theatres On-Site</h4>
        <div id="noStyle">
            <?php echo $theatre['previous_theatres_onsite'];?>
        </div>
        <h4>Alterations, Redecorations, Renovations, Recontructions done on this site</h4>
        <div id="noStyle">
            <?php echo $theatre['alts_renovs_list'];?>
        </div>
        <h3><a name="current_desc">Description of Current Theatre</a></h3>
        <div id="noStyle">
            <?php echo $theatre['desc_current'];?>
        </div>
        <h3><a name="measurements">Measurements and Technical Details</a></h3>
        <div id="noStyle">
            <?php echo $theatre['measurements'];?>
        </div>
