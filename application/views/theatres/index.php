<div class="theatres">
	...
	<div class="facets" id="exhibit-facets">
		<div ex:role="facet" ex:facetClass="TextSearch" ex:expressions=".label, .country_name, .period_rep, .sub_type, .city.label, .theatre_aliases, .city.aliases, .normalized_label, .city.normalized_aliases, .city.normalized_label" ex:facetLabel="Search"></div>
