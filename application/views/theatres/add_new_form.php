...
<div class="grid_12 featuredarea">   
	...
	<input type="hidden" id="city_id" name="city_id" value="new" />
	<div class="clear"></div>
	<div class="grid_3 alpha sidebar">
		<div class="entryDetails">
			...
			<!-- for Add New entry, we can't have Scholarly Details or Biblio active until we have a theatre, with its theatre_id initialized in database -->
			<h4 class="inactive"><a href="#">Scholarly details</a></h4>
                 <ul class="inactive">
		...
		<!--<h4 class="inactive"><a href="#">Bibliography</a></h4>
		<h4 class="inactive"><a href="#">Entry author/editors</a></h4>
		-->
...
<div class="grid_9 omega maincontent"> <!-- Content area -->
	...
	<div class="grid_9 basics alpha">                      
		<div class="grid_9 alpha omega">
            ...
            <input type="hidden" id="db_star_rating" name="db_star_rating" value="1"/>
			<p class="rating"><div class="grid_2 alpha">
             ...
             <em>Rate this theatre (1-5 stars, default is 1)</em>
			</div></p>
		<div class="clear"></div>
		<hr>
		<div class="grid_9 alpha omega">
		...
		<div class="grid_9 alpha omega">
			...
			<div class="clear"></div>
			<div class="grid_1 alpha"><strong>Type:</strong></p></div>
			<div class="grid_5 alpha" id="type_wrapper"><p><?php echo $sub_type;?></p></div>
			<div class="grid_3 omega"></div>
			<div class="clear"></div>
			<div class="grid_1 alpha"><p><strong>Range (start)</strong></p></div>
			<div class="grid_4 alpha"><p><?php echo $est_earliest;?>CE<?php echo $earliest_ce;?> BCE<?php echo $earliest_bce;?></p>
		    </div>
			<div class="grid_4 omega"></div>
			<div class="clear"></div>
			<div class="grid_1 alpha"><p><strong>Range (end)</strong></p></div> 
			<div class="grid_4 alpha"><p><?php echo $est_latest;?>CE<?php echo $latest_ce;?> BCE<?php echo $latest_bce;?></p>
			</div>
			<div class="grid_4 omega"></div>
			<div class="clear"></div>
			<div class="grid_1 alpha"><p><strong>House Date</strong> (Auditorium)</p></div>
			<div class="grid_4 alpha"><p><?php echo $auditorium_date;?></p>
			<div class="grid_4 omega"></div>
			</div>
			<div class="clear"></div>
			<div class="grid_1 alpha"><strong><p>Entry Lister</strong></p></div>
			<div class="grid_3 alpha"><?php echo $first_lister_input;?></div>
