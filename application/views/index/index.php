...
<div class="grid_12 maincontent">
    <div class="grid_6 alpha featured_text"><a id="about"></a>
        ...
        <p>For more details visit the <a href="index/about">about finder</a> page. To apply to join the project, visit the <a
href="index/contribute">contribute</a>
section.</p>
    </div>
       ...
       <div class="grid_2 boxgrid captionfull">
		...
		<div class="grid_12 featuredarea">
		    ...
		    <div class="grid_4 omega featuredsidebar" >
				...
				<div class="grid_4 alpha omega theatre" id="featured_one">
