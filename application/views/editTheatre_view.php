...
<script type="text/javascript" src="<?= base_url();?>javascript/mainEdit.js"></script>
<script type="text/javascript" src="<?= base_url();?>/javascript/ckeditor/ckeditor.js"></script>


</head>
<body>
<?=form_open('theatreCtrl/editTheatre/'); ?>
<?=form_hidden('idData',$this->uri->segment(3));?>
<div class="container_12 clearfix">
	<br>
	<div class="grid_4 alpha"><h3><?=$heading?></h3></div>
	<div class="grid_8 omega"><p><input type="submit" value="Update" /></p></div>
