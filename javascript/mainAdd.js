jQuery(document).ready(function($){
	...
	// Add the default star rating ("1") from the hidden input, id="db_star_rating"
			...
			success: function(data){
				...
				for (var i = 0; i < data.length; i++) {
					...
					if (data[i].t_type == 'UniqueOther') {
						...
						$('#type_wrapper').append('<input id="sub_type" name="sub_type" type="text" size"16" max="64"></input>');
